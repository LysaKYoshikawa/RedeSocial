...
namespace RedeSocial.DAL.Data
{
    ...
    public class DesignTimeDbContextFactory : IDesignTimeDbContextFactory<RedeSocialAPIContext>
    {
        ...
        {
            IConfigurationRoot configuration = new ConfigurationBuilder().SetBasePath(Directory.GetCurrentDirectory()).AddJsonFile(Directory.GetCurrentDirectory() + "/../RedeSocialAPI/appsettings.json").Build();
